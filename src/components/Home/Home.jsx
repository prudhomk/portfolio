      ...
      <div className={styles.Home}>
        <div>
          ...
          <figure>
            ...
            <a href="https://chordial.netlify.app/" target="_blank" rel="noreferrer"><LinkedInIcon className="icon" /></a>
          ...
          <figure>
            ...
            <a href="https://addons.mozilla.org/en-US/firefox/addon/web-wizard/" target="_blank" rel="noreferrer"><LinkedInIcon className="icon" /></a>
          ...
          <figure>
            ...
            <a href="https://elated-brattain-3eaa48.netlify.app/" target="_blank" rel="noreferrer"><LinkedInIcon className="icon" /></a>
          ...
          <figure>
            ...
            <a href="https://gaka-daka.github.io/io-spio/" target="_blank" rel="noreferrer"><LinkedInIcon className="icon" /></a>
